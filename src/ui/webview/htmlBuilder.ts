...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${cspSource} https://cdn.jsdelivr.net; font-src ${cspSource} https://cdn.jsdelivr.net; script-src 'nonce-${nonce}'; img-src ${cspSource}">
